...
def run_model_generate(**context):
...
def run_preprocess_generate (**context):
    """Executa abt_transform.py - Clean -> ABT."""
    import subprocess
    import sys
    import logging
...
sensor_refined_fraud_data_pipeline = ExternalTaskSensor(
    task_id='sensor_refined_fraud_data_pipeline',
    external_dag_id='refined_fraud_data_pipeline', 
...
sensor_refined_fraud_data_pipeline >> model_generate_task >> preprocess_generate_task